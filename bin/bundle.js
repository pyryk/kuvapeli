...
/***/ function(module, exports, __webpack_require__) {
	...
	function main() {
		return {
			DOM: _cycleCore2['default'].Rx.Observable.interval(1000).startWith(0).map(function (i) {
				return _cycleDom2['default'].h('h1.' + _appCss2['default'].app, '' + i + ' seconds elapsed');
			})
		};
	}

	var drivers = {
		DOM: _cycleDom2['default'].makeDOMDriver('#app')
	};
