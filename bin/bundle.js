...
/***/ function(module, exports, __webpack_require__) {
	...
	var _seededshuffle = __webpack_require__(126);
	...
	var debug = function debug(label) {
		return function () {
			...
			return (_console = console).log.apply(_console, _toConsumableArray([label].concat(args)));
		};
	};
	...
	function main(_ref) {
		...
		var setupPanel = (0, _setup.setup)({ DOM: DOM });
	
		var shuffledImages$ = setupPanel.value$.map(function (images) {
			return _seededshuffle2.default.shuffle(images, shuffleSeed, true);
		});
		...
		var submit$ = DOM.select('#answer').events('keyup').map(function (ev) {
			...
			return code === 13;
		}).withLatestFrom(inputValue$, function (code, value) {
			return value;
		}).startWith(null);
		...
		var tabProps$ = state$.combineLatest(setupPanel.DOM, function (props, setupVTree) {
			return { default: 'tab1', children: tabChildren(props, setupVTree) };
		});
		var tabPanel = (0, _tabs.tabs)({ DOM: DOM, props$: tabProps$ });
	
		return {
			DOM: state$.combineLatest(tabPanel.DOM, function (props, tabsVTree) {
				return h2('div.app', [(0, _dom.h)('h1', 'Kuvapeli'), tabsVTree]);
			})
		};
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mockDOMResponse = __webpack_require__(120);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var attributeHook = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rx = __webpack_require__(3);
	var fromEvent = __webpack_require__(28);
	var VDOM = {
	  h: __webpack_require__(29),
	  diff: __webpack_require__(30),
	  patch: __webpack_require__(36),
	  parse: typeof window !== "undefined" ? __webpack_require__(45) : function () {}
	};
	...
	try {
	  matchesSelector = __webpack_require__(106);
	} catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var propertyMap = __webpack_require__(46);
	var namespaceMap = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Map = Map || __webpack_require__(50); // eslint-disable-line no-native-reassign
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(51)() ? Map : __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clear          = __webpack_require__(53)
	  , eIndexOf       = __webpack_require__(55)
	  , setPrototypeOf = __webpack_require__(61)
	  , callable       = __webpack_require__(66)
	  , validValue     = __webpack_require__(54)
	  , d              = __webpack_require__(67)
	  , ee             = __webpack_require__(79)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assign        = __webpack_require__(68)
	  ...
	  , isCallable    = __webpack_require__(75)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isString       = __webpack_require__(85)
	  , iteratorSymbol = __webpack_require__(86).iterator
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isString = __webpack_require__(85)
	  , ArrayIterator  = __webpack_require__(93)
	  , StringIterator = __webpack_require__(100)
	  , iterable       = __webpack_require__(83)
	  , iteratorSymbol = __webpack_require__(86).iterator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(99)('forEach');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setPrototypeOf    = __webpack_require__(61)
	  , d                 = __webpack_require__(67)
	  , Iterator          = __webpack_require__(94)
	  , toStringTagSymbol = __webpack_require__(80).toStringTag
	  , kinds             = __webpack_require__(102)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(103)('key',
		'value', 'key+value');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rx = __webpack_require__(3);
	var VirtualNode = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Rx = __webpack_require__(3);
	var toHTML = __webpack_require__(108);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isThunk = __webpack_require__(14);
	var isWidget = __webpack_require__(13);
	var softHook = __webpack_require__(20);
	var attrHook = __webpack_require__(26);
	var paramCase = __webpack_require__(111);
	var createAttribute = __webpack_require__(117);
	var voidElements = __webpack_require__(119);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var sentenceCase = __webpack_require__(112);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lowerCase = __webpack_require__(113)
	
	var NON_WORD_REGEXP = __webpack_require__(114)
	var CAMEL_CASE_REGEXP = __webpack_require__(115)
	var TRAILING_DIGIT_REGEXP = __webpack_require__(116)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var escape = __webpack_require__(109);
	var propConfig = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var h2 = (0, _cssModulesVdom2.default)(_app2.default, 'tab1', 'tab2');
	...
	function tabs(_ref) {
		...
		var value$ = initialValue$.concat(_rx2.default.Observable.merge(tab1$, tab2$)).do(function (v) {
			return console.log(v);
		});
	
		var vtree$ = _rx2.default.Observable.combineLatest(props$, value$, function (props, value) {
			return (0, _dom.h)('div.tabs-container', [h2('div.tabs', [h2('div.tab1' + (value === 'tab1' ? '.active' : ''), ['Setup']), h2('div.tab2' + (value === 'tab2' ? '.active' : ''), ['Peli'])]), (0, _dom.h)('div.container', value === 'tab1' ? props.children[0] : props.children[1])]);
		});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (styles) {
		...
		return function h2(selector) {
			...
			var element = _selector$split2[0];
			...
			return _dom.h.apply(_dom.h, [element + ids.map(function (id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hh = (0, _hyperscriptHelpers2.default)(_dom.h);
	...
	function setup(_ref) {
		...
		var written$ = DOM.select('textarea').events('change').map(function (ev) {
			...
			return console.log('written', values);
		}).startWith([]);
	
		var dragEnter$ = DOM.select('.' + _app2.default['drop-target']).events('dragenter').map(dragenter).startWith(undefined);
		var dragOver$ = DOM.select('.' + _app2.default['drop-target']).events('dragover').map(dragover).startWith(undefined);
	
		var dropped$ = DOM.select('.' + _app2.default['drop-target']).events('drop').map(function (e) {
			e.preventDefault();
			e.stopPropagation();
		...
		var value$ = written$.combineLatest(dropped$, function (written, dropped) {
			...
			return (_console = console).log.apply(_console, ['setup images'].concat(args));
		});
	
		var showFiles = function showFiles(images) {
			if (images && images.length > 0) {
				return ul(images.map(function (image) {
					return li([a({ href: image.url, target: '_blank' }, image.answer)]);
				}));
			} else {
				return '';
			}
		...
		var vtree$ = _rx2.default.Observable.combineLatest(value$, written$, dropped$, dragEnter$, dragOver$, function (value, written, dropped) {
			return div('.setup', [h2('.label', ['Kuvat']), div('.' + _app2.default['drop-target'] + '.drop-target', ['Raahaa tiedostot tähän ', showFiles(dropped)]), div('.' + _app2.default['image-list'] + '.image-list', value.map(function (image) {
				return img({ src: image.url, title: image.answer });
			})), div('.textarea-hint', 'Tai syötä kuvien URL:t alle'), textarea('.' + _app2.default.images, {
				value: written.map(function (v) {
					return v.url;
				}).join('\n')
			})]);
		});
